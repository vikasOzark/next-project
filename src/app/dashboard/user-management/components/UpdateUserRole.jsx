        ...
        <DropdownMenuContent className="w-56">
          ...
          <DropdownMenuGroup>
            <DropdownMenuItem
              ...
              className={
                "hover:bg-gray-300 flex items-center gap-2 cursor-pointer font-bold"
              }
            >
              <VscSparkle size={18} className="font-bold" fontWeight={800} />
              Alter role
            </DropdownMenuItem>
          </DropdownMenuGroup>
        </DropdownMenuContent>
    ...
    <>
      <form onSubmit={mutationFn.mutate}>
        ...
        <div className="mb-2">
          ...
          <small>Please enter your password to conform your identity.</small>
