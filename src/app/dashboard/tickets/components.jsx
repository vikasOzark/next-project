...
export const TableRow = () => {
  ...
  // {
  //   id: '6540cc080f3f527f2d0ab80e',
  //   taskTitle: 'as',
  //   ticketDetil: 'asa',
  //   status: 'PENDING',
  //   departmentId: '653ceb8d85741601a05f2b04',
  //   userId: '653750505572dfd718166890',
  //   tagId: null,
  //   createdAt: '2023-10-31T09:42:32.296Z',
  //   department: {
  //     id: '653ceb8d85741601a05f2b04',
  //     name: 'etsting',
  //     userId: '653750505572dfd718166890',
  //     updated_at: '2023-10-28T11:07:56.954Z',
  //     createdAt: '2023-10-28T11:07:56.954Z'
  //   }
  // },
              ...
              <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                {responseData.isSuccess &&
                  responseData.data.data?.map((ticket) => (
                    <TableBodyRow key={ticket.id} data={ticket} />
                  ))}
              </tbody>
            </table>
          </div>
  ...
  return (
    <tr>
      ...
      <td className="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
        <div className="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-300 dark:bg-gray-800">
