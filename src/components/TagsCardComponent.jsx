...
export default function TagsCardComponent({ onClick }) {
    ...
    return (
        ...
        >
            <div
                ...
                className="rounded-lg my-2 hover:border-gray-700 border border-transparent transition-all temp-bg"
            >
                <input
                    type="search tags"
            ...
            <Card>
                    ...
                    {filtered_tags.map((tag) => {
                        return (
                            <div
                                ...
                                onClick={() => onClick(tag)}
                                className={cn(
                                    "p-1 mb-1 cursor-pointer hover:border-gray-200 transition-all hover:border-2 border-2 border-transparent rounded-md ",
                                    tag.color
                                )}
                            >
                                {tag.title}
                ...
                {!isLoading && isOpenState && filtered_tags.length === 0 && (
                    <EmptyState
                        className={"text-lg"}
                        size={32}
